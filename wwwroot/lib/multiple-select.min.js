...
!(function (t, e) {
  ...
  var S,
    ...
    ct = lt && lt.v8;
  ct && (k = (S = ct.split('.'))[0] > 0 && S[0] < 4 ? 1 : +(S[0] + S[1])),
    !k && ot && (!(S = ot.match(/Edge\/(\d+)/)) || S[1] >= 74) && (S = ot.match(/Chrome\/(\d+)/)) && (k = +S[1]);
  var ht = k,
    ft = ht,
    dt = p,
    pt = f.String,
      ...
      ? function (t, e, n) {
          if (
            ...
            i &&
              i[Je] &&
              ((t[e] = n.value),
              (n = { configurable: Xe in n ? n[Xe] : i[Xe], enumerable: Ye in n ? n[Ye] : i[Ye], writable: !1 }));
          }
          return Ve(t, e, n);
        }
      : Ve
  ...
  var ti = en.exports,
    ...
    ri = function (t, e, n, i) {
      ...
      if ((ei(n) && ii(n, r, i), i.global)) u ? (t[e] = n) : ui(e, n);
        ...
        u
          ? (t[e] = n)
          : ni.f(t, e, { value: n, enumerable: !1, configurable: !i.nonConfigurable, writable: !i.nonWritable });
      }
      return t;
    },
    oi = {},
    ...
    su = function (t, e) {
      ...
      if ((n = a ? tu : l ? tu[s] || uu(s, {}) : (tu[s] || {}).prototype))
        for (i in e) {
          if (
            ((r = e[i]),
            (u = t.dontCallGetSet ? (o = eu(n, i)) && o.value : n[i]),
            !ou(a ? i : s + (l ? '.' : '#') + i, t.forced) && void 0 !== u)
          ) {
  ...
  var Zu,
    ...
    tr =
      ...
      function (t, e) {
        var n;
        return (
          null !== t ? ((qu[zu] = Pu(t)), (n = new qu()), (qu[zu] = null), (n[Vu] = t)) : (n = Ju()),
          void 0 === e ? n : Nu.f(n, e)
        );
      },
    er = p,
      ...
      if (
        (d &&
          ...
          a.lastIndex > 0 &&
            ...
            ((v = '(?: ' + v + ')'), (E = ' ' + E), g++),
          (n = new RegExp('^(?:' + v + ')', p))),
        kr && (n = new RegExp('^' + v + '$(?!\\s)', p)),
        Fr && (i = a.lastIndex),
        (u = sr(Er, d ? n : a, E)),
        d
          ? u
            ? ((u.input = Cr(u.input, g)), (u[0] = Cr(u[0], g)), (u.index = a.lastIndex), (a.lastIndex += u[0].length))
            : (a.lastIndex = 0)
          : Fr && u && (a.lastIndex = a.global ? u.index + u[0].length : i),
        kr &&
          u &&
          u.length > 1 &&
          sr(gr, u[0], n, function () {
            for (r = 1; r < arguments.length - 2; r++) void 0 === arguments[r] && (u[r] = void 0);
          }),
        u && f)
      )
        for (u.groups = o = fr(null), r = 0; r < f.length; r++) o[(s = f[r])[0]] = u[s[1]];
      return u;
    });
  var Dr = br;
      ...
      if (!r || !o || n) {
        var s = $r(/./[u]),
          a = e(u, ''[t], function (t, e, n, i, u) {
            var o = $r(t),
              a = e.exec;
            return a === jr || a === _r.exec
              ? r && !u
                ? { done: !0, value: s(e, n, i) }
                : { done: !0, value: o(n, e, i) }
              : { done: !1 };
          });
  ...
  var eo = le,
    ...
    uo = eo('unscopables'),
    ro = Array.prototype;
  null == ro[uo] && io(ro, uo, { configurable: !0, value: no(null) });
  var oo = function (t) {
      ro[uo][t] = !0;
    },
    so = Si.includes,
  ...
  var ns =
    ...
    as = function (t) {
      ...
      return (
        is(t) &&
          ((e = t.constructor),
          ((us(e) && (e === ss || is(e.prototype))) || (rs(e) && null === (e = e[os]))) && (e = void 0)),
        void 0 === e ? ss : e
      );
    },
    ls = function (t, e) {
  ...
  ps(
    { target: 'Array', proto: !0, arity: 1, forced: !Ds || !Fs('concat') },
    {
      concat: function (t) {
        var e,
          n,
        ...
        for (e = -1, i = arguments.length; e < i; e++)
          if (xs((r = -1 === e ? o : arguments[e])))
            for (u = ys(r), ms(a + u), n = 0; n < u; n++, a++) n in r && As(s, a, r[n]);
          else ms(a + 1), As(s, a++, r);
        return (s.length = a), s;
      }
    }
  );
  var ws = v,
    ...
    Ns =
      ...
      Bs(function () {
        ...
        ? function (t, e) {
            for (var n = Is(t), i = arguments.length, u = 1, r = Ts.f, o = Ls.f; i > u; )
              for (var s, a = Rs(arguments[u++]), l = r ? Ps(js(a), r(a)) : js(a), c = l.length, h = 0; c > h; )
                (s = l[h++]), (ws && !$s(o, a, s)) || (n[s] = a[s]);
            return n;
          }
        : _s,
    Hs = Ns;
  su({ target: 'Object', stat: !0, arity: 2, forced: Object.assign !== Hs }, { assign: Hs });
  var Us = {
      name: '',
      placeholder: '',
      classes: '',
  ...
  var Ws = {
      ...
      return function (e, n) {
        ...
        return o < 0 || o >= s
          ? t
            ? ''
            : void 0
          : (i = aa(r, o)) < 55296 || i > 56319 || o + 1 === s || (u = aa(r, o + 1)) < 56320 || u > 57343
          ? t
            ? sa(r, o)
            : i
          : t
    ...
    ha = { codeAt: ca(!1), charAt: ca(!0) }.charAt,
    fa = function (t, e, n) {
    ...
    $a = $t,
    Ba = function (t, e, n) {
      for (var i = pa(t), u = da(e, i), r = da(void 0 === n ? i : n, i), o = ga(Ea(r - u, 0)), s = 0; u < r; u++, s++)
        va(o, s, t[u]);
      return (o.length = s), o;
    },
    ja = Kr,
            ...
            ? function (t, n) {
                ...
                for (
                  ...
                  !(
                    (o = h.lastIndex) > c &&
                    (Na(a, Ha(i, c, r.index)),
                    r.length > 1 && r.index < i.length && ba(Ma, a, Ba(r, 1)),
                    (s = r[0].length),
                    (c = o),
                    a.length >= u)
                  );
                ...
                return (
                  c === i.length ? (!s && Pa(h, '')) || Na(a, '') : Na(a, Ha(i, c)), a.length > u ? Ba(a, 0, u) : a
                );
              }
        ...
        [
          ...
          function (t, u) {
            ...
            for (var d = 0, p = 0, v = []; p < o.length; ) {
              ...
              var g,
                E = ja(h, Ia ? Ha(o, p) : o);
              if (null === E || (g = _a(wa(h.lastIndex + (Ia ? p : 0)), o.length)) === d) p = xa(o, p, l);
              else {
  ...
  var Ga = p,
    ...
    Ya = B([].join);
  za(
    { target: 'Array', proto: !0, forced: Ka != Object || !qa('join', ',') },
    {
      join: function (t) {
  ...
  var Xa = ti,
    ...
    tl = B,
    el = function (t, e, n) {
      return n.get && Xa(n.get, e, { getter: !0 }), n.set && Xa(n.set, e, { setter: !0 }), Ja.f(t, e, n);
    },
  ...
  lu || ri(Object.prototype, 'toString', Fl, { unsafe: !0 });
  var Sl = gl.map;
  su(
    { target: 'Array', proto: !0, forced: !ds('map') },
    {
      map: function (t) {
  ...
  var kl = v,
    ...
    Bl = function (t) {
      return function (e) {
        for (var n, i = wl(e), u = xl(i), r = u.length, o = 0, s = []; r > o; )
          (n = u[o++]), (kl && !Ol(i, n)) || $l(s, t ? [n, i[n]] : i[n]);
        return s;
      };
    },
    jl = { entries: Bl(!0), values: Bl(!1) }.entries;
  su(
  ...
  var Il = gl.filter;
  su(
    { target: 'Array', proto: !0, forced: !ds('filter') },
    {
      filter: function (t) {
  ...
  var ql = B([].slice),
    ...
    ac = Math.max;
  Yl(
    { target: 'Array', proto: !0, forced: !rc },
    {
      slice: function (t, e) {
        var n,
          i,
        ...
        if (
          Xl(r) &&
          ((n = r.constructor),
          ((Jl(n) && (n === sc || Xl(n.prototype))) || (Zl(n) && null === (n = n[oc]))) && (n = void 0),
          n === sc || void 0 === n)
        )
          return uc(r, s, a);
  ...
  var lc = y,
    ...
    Cc = bc(function () {
      return '/a/b' != Ac.call({ source: 'a', flags: 'b' });
    }),
    Fc = pc && Ac.name != mc;
  (Cc || Fc) &&
    vc(
        ...
        u(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.blockHeight = this.itemHeight * Ws.BLOCK_ROWS),
                (this.clusterRows = Ws.BLOCK_ROWS * Ws.CLUSTER_BLOCKS),
                (this.clusterHeight = this.blockHeight * Ws.CLUSTER_BLOCKS);
            }
          },
          {
            key: 'getNum',
          ...
          },
          {
            key: 'initData',
            value: function (t, e) {
              if (t.length < Ws.BLOCK_ROWS) return { topOffset: 0, bottomOffset: 0, rowsAbove: 0, rows: t };
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                (n.className = 'virtual-scroll-'.concat(t)), e && (n.style.height = ''.concat(e, 'px')), n.outerHTML
              );
            }
          }
        ]),
      ...
      return [
        ...
        function (t, u) {
          ...
          for (var d, p = '', v = 0, g = 0; g < h.length; g++) {
            for (var E = Gc((f = h[g])[0]), b = Xc(Jc(Hc(f.index), o.length), 0), y = [], m = 1; m < f.length; m++)
              Qc(y, void 0 === (d = f[m]) ? d : String(d));
            var A = f.groups;
            if (a) {
              var C = Zc([E], y, b, o);
              void 0 !== A && Qc(C, A);
  ...
  var uh = xt,
    ...
    ch = { left: lh(!1), right: lh(!0) },
    hh = 'undefined' != typeof process && 'process' == I(process),
    fh = ch.left;
  su(
    { target: 'Array', proto: !0, forced: (!hh && ht > 79 && ht < 83) || !Wa('reduce') },
    {
      reduce: function (t) {
      ...
      return (
        u(i, [
          ...
          },
          {
            ...
            value: function () {
              ...
              this.options.classes && this.$el.addClass(this.options.classes),
                ...
                !this.$label.length &&
                  this.$el.attr('id') &&
                  (this.$label = t('label[for="'.concat(this.$el.attr('id'), '"]'))),
              ...
              var u = '';
              if (
                (null !== this.tabIndex && (u = this.tabIndex && 'tabindex="'.concat(this.tabIndex, '"')),
                  ...
                  .on(r, function (i) {
                    t(i.target)[0] !== e.$choice[0] &&
                      ...
                      (t(i.target)[0] === e.$drop[0] ||
                        (t(i.target).parents('.ms-drop')[0] !== e.$drop[0] && i.target !== n)) &&
                      e.options.isOpen &&
                      e.close();
                  });
              }
                    ...
                    'optgroup' === t.type
                      ? ((t._key = 'group_'.concat(n)),
                        ...
                        t.children.forEach(function (t, i) {
                          (t.visible = void 0 === t.visible || t.visible),
                            t.divider || ((t._key = 'option_'.concat(n, '_').concat(i)), (e += 1));
                        }))
                      : ((t.visible = void 0 === t.visible || t.visible),
                        t.divider || ((t._key = 'option_'.concat(n)), (e += 1)));
                  }),
                  e
                );
              })(this.data);
              ...
              return o.is('option')
                ? ((r.type = 'option'),
                  ...
                  Object.keys(o.data()).length &&
                    ((r._data = o.data()), r._data.divider && (r.divider = r._data.divider)),
                  r)
                : o.is('optgroup')
                ? ((r.type = 'optgroup'),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                e.length > Ws.BLOCK_ROWS * Ws.CLUSTER_BLOCKS)
              ) {
                ...
                this.options.selectAll &&
                  ...
                  e.push(
                    '\n        <li class="ms-select-all" tabindex="0">\n        <label>\n        <input type="checkbox" '
                      ...
                      .concat(this.allSelected ? ' checked="checked"' : '', ' tabindex="-1" />\n        <span>')
                ...
                return (
                  ...
                  c.push(
                    '\n        <li class="group '
                      .concat(s, '" ')
                      .concat(l, ' tabindex="')
                      .concat(s.includes('hide-radio') || t.disabled ? -1 : 0, '">\n        <label class="optgroup')
              ...
              this.$label &&
                ...
                this.$label.off('click').on('click', function (t) {
                  'label' === t.target.nodeName.toLowerCase() &&
                    (n(t), (e.options.filter && e.options.isOpen) || e.focus(), t.stopPropagation());
                }),
                this.$choice
                  .off('click')
                  .on('click', n)
                ...
                this.$selectItems.off('click').on('click', function (n) {
                  ...
                  !1 !== e.options.onBeforeClick(r)
                    ? (e._check(r, u),
                      e.options.onClick(vh({ text: r.text, value: r.value, selected: r.selected, data: r._data })),
                      o())
                    : o();
                }),
                this.$ul
                  ...
                  .on('keydown', function (n) {
                    ...
                    switch (n.key) {
                      ...
                      case 'Enter':
                        n.preventDefault(),
                          u.find('input').trigger('click'),
                          e.options.single && e.$choice.trigger('focus');
                    }
                  });
            }
          },
            ...
            value: function () {
              if (!this.$choice.hasClass('disabled')) {
                ...
                'row' === this.options.maxHeightUnit &&
                  (n = this.$drop.find('>ul>li').first().outerHeight() * this.options.maxHeight),
                  this.$drop.find('>ul').css('max-height', ''.concat(n, 'px')),
                  this.$drop.find('.multiple').css('width', ''.concat(this.options.multipleWidth, 'px')),
                  this.data.length &&
                    this.options.filter &&
                    (this.$searchInput.val(''), this.$searchInput.focus(), this.filter(!0)),
                  this.options.onOpen();
              }
            }
          },
          {
            ...
            value: function () {
              (this.options.isOpen = !1),
                ...
                this.options.container &&
                  (this.$parent.append(this.$drop), this.$drop.css({ top: 'auto', left: 'auto' })),
          ...
          },
          {
            ...
            value: function (t) {
              return (
                { show: { fade: 'fadeIn', slide: 'slideDown' }, hide: { fade: 'fadeOut', slide: 'slideUp' } }[t][
              ...
              0 === u
                ...
                : (r =
                    u < this.options.minimumCountSelected
                      ...
                      ? ''.concat(
                          n.slice(0, this.options.minimumCountSelected).join(this.options.displayDelimiter),
                          '...'
                        )
            ...
            value: function (t, e) {
              ...
              try {
                for (i.s(); !(n = i.n()).done; ) {
                  var u = n.value;
                  'optgroup' === u.type
                    ? this._checkGroup(u, t, !0)
                    : u.disabled || u.divider || (!e && !u.visible) || (u.selected = t);
                }
              } catch (t) {
                i.e(t);
              } finally {
                ...
                try {
                  for (u.s(); !(i = u.n()).done; ) {
                    ...
                    if ('optgroup' === r.type)
                      ...
                      r.visible = this.options.customFilter({
  ...
  (t.fn.multipleSelect = function (n) {
    ...
    (t.fn.multipleSelect.Constructor = gh),
    (t.fn.multipleSelect.defaults = Ws.DEFAULTS),
    (t.fn.multipleSelect.locales = Ws.LOCALES),
    (t.fn.multipleSelect.methods = Ws.METHODS);
});
1;
